...
import BrowserWidgetTemplate from '../../../templates/tasks/overlays/browserWidget.pug';
...
var BrowserWidget = View.extend({
    ...
    initialize: function (settings) {
        ...
        this.selectFolder = !!settings.selectFolder;
    ...
    _renderHierarchyView: function () {
        ...
        this._hierarchyView = new HierarchyWidget({
            ...
            onFolderSelect: _.bind(this._selectFolder, this),
            showMetadata: this.showMetadata
        });
        this.listenTo(this._hierarchyView, 'g:selected', function(folder) {
            if (folder.get('_modelType') === 'folder') {
                this.trigger('g:selected', folder);
            } else {
                this.$('.g-validation-failed-message').addClass('hidden').html('');
                this.$('.g-validation-failed-message').removeClass('hidden').text('Need to be a folder');
            }
        }, this);
        // this._selectModel();
    },
    ...
    _selectFolder: function (folder) {
        if (!this.selectFolder) {
            return;
        }
        this._resetSelection(folder);
    },
